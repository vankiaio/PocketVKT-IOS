...
@property(nonatomic , strong) Get_pocketvkt_info_request *get_pocketvkt_info_request;
@end
...
- (Get_pocketvkt_info_request *)get_pocketvkt_info_request{
    if (!_get_pocketvkt_info_request) {
        _get_pocketvkt_info_request = [[Get_pocketvkt_info_request alloc] init];
    }
    return _get_pocketvkt_info_request;
}
...
- (void)buildDataSource{
    WS(weakSelf);
    [self.get_pocketvkt_info_request getDataSusscess:^(id DAO, id data) {
        Get_pocketvkt_info_Result *result = [Get_pocketvkt_info_Result mj_objectWithKeyValues:data];
