...
- (NavigationView *)navView{
    if (!_navView) {
        _navView = [[NavigationView alloc] initNavigationViewWithFrame:(CGRectMake(0, 0, SCREEN_WIDTH, NAVIGATIONBAR_HEIGHT)) LeftBtnImgName:@"back_white" titleImage:@"PocketVKT" rightImgName:@"addFollow" delegate:self];
    }
    return _navView;
}
